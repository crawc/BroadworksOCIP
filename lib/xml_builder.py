...
class Xml_builder:
    ...
    def __init__(self):
        ...
        self._supported_api_calls = {
            ...
            "GroupServiceGetAuthorizationListRequest": {
                "serviceProviderId": None,
                "groupId": None,
                "order": ["serviceProviderId", "groupId"],
            },
            ...
            "UserVoiceMessagingUserModifyVoicePortalRequest20": {
                "voicePortalAutoLogin": None,
                "userId": None,
                "order": ["userId", "voicePortalAutoLogin"],
            },
            "UserModifyRequest17sp4": {
                "userId": None,
                "timeZone": None,
                "language": None,
                "callingLineIdPhoneNumber": None,
                "order": ["userId", "timeZone", "language", "callingLineIdPhoneNumber"],
            },
            "UserCallRecordingModifyRequest": {
                "userId": None,
                "recordingOption": None,
                "order": ["userId", "recordingOption"],
            },
            "UserHotelingGuestModifyRequest": {
                "userId": None,
                "isActive": None,
                "enableAssociationLimit": None,
                "associationLimitHours": None,
                "order": [
                    "userId",
                    "isActive",
            ...
            "SystemSIPDeviceTypeFileModifyRequest16sp1": {
                "deviceType": None,
                "fileFormat": None,
                "fileCustomization": None,
                "fileUpload": {"sourceFileName": None, "fileContent": None},
                "order": [
                    "deviceType",
                    "fileFormat",
                    "fileCustomization",
            ...
            "SystemSIPDeviceTypeFileGetRequest20": {
                "deviceType": None,
                "fileFormat": None,
                "order": ["deviceType", "fileFormat"],
            },
            "UserAuthenticationModifyRequest": {
                "userId": None,
                "newPassword": None,
                "order": ["userId", "newPassword"],
            },
            "UserCallForwardingNotReachableModifyRequest": {
                "userId": None,
                "isActive": None,
                "forwardToPhoneNumber": None,
                "order": ["userId", "isActive", "forwardToPhoneNumber"],
            },
            "GroupModifyRequest": {
                "serviceProviderId": None,
                "groupId": None,
                ...
                "userLimit": None,
                "groupName": None,
                "callingLineIdName": None,
                "callingLineIdPhoneNumber": None,
                "timeZone": None,
                "locationDialingCode": None,
                "contact": None,
                "address": {},
                "order": [
                    "serviceProviderId",
            ...
            "UserVoiceMessagingUserModifyVoicePortalRequest20": {
                "userId": None,
                "usePersonalizedName": None,
                "voicePortalAutoLogin": None,
                "personalizedNameAudioFile": None,
                "order": [
                    "userId",
                    "usePersonalizedName",
            ...
            "UserVoiceMessagingUserModifyAdvancedVoiceManagementRequest": {
                "userId": None,
                "groupMailServerEmailAddress": None,
                "groupMailServerUserId": None,
                "groupMailServerPassword": None,
                "order": [
                    "userId",
    ...
    def _build_apicall(self, api_call, options_dict):
        ...
        for sub_element in options_dict:
            try:
                if (
                    type(self._supported_api_calls[api_call][sub_element]).__name__
                    == "dict"
                ):
                    for sub_sub_element in options_dict:
                        self._supported_api_calls[api_call][sub_element][
                            sub_sub_element
                        ] = options_dict[sub_sub_element]
                else:
                    self._supported_api_calls[api_call][sub_element] = options_dict[
                        sub_element
                    ]
            except KeyError as e:
